...
apply_plsda = function(dataset, classes, components = 10, cv_folds = 5, cv_repeats = 10){
...
apply_workflow = function(dataset, classes, fisher_variables = 5000, relieff_variables = 500, pca_components = 10, cv_folds = 5, cv_repeats = 10){
	...
	final_results = apply_plsda(after_relieff, classes)
